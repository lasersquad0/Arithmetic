...
public:
	static IModel* GetModelAndCoder(FileRecord& fr)
	{
		...
		{
		case ModelType::O0:    models[fr.modelOrder][fr.alg] = new ModelOrder0(coder); return models[fr.modelOrder][fr.alg]; break;
		case ModelType::O1:    models[fr.modelOrder][fr.alg] = new ModelOrder1(coder); return models[fr.modelOrder][fr.alg]; break;
		case ModelType::O2:    models[fr.modelOrder][fr.alg] = new ModelOrder2(coder); return models[fr.modelOrder][fr.alg]; break;
		case ModelType::O3:    models[fr.modelOrder][fr.alg] = new ModelOrder3(coder); return models[fr.modelOrder][fr.alg]; break;
		case ModelType::MIXO3: models[fr.modelOrder][fr.alg] = new ModelOrderMixed(coder); return models[fr.modelOrder][fr.alg]; break;
